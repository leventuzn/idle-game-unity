    ...
    public void FloatingTextAnimation(ResourceType resource, int amount, Vector3 position)
    {
        ...
        switch (resource)
        {
            case ResourceType.Gold:
                floatingText.transform.position = position + new Vector3(-30f, 10f, 0f);
        ...
        LeanTween.moveY(floatingText, transform.position.y + 50, 0.8f).setEaseInOutQuad().setOnComplete(() => {
